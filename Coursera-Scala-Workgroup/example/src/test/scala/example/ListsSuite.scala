  ...
  test("sum of a few numbers") {
   ...
   test("sum of a few  negative numbers") {
    assert(Lists.sum(List(-1,-2,0)) === -3)
     ...
     test("sum of a few  mixed numbers") {
    assert(Lists.sum(List(-1,-2,0,3)) === 0)
  }
  test("max of a few numbers") {
    assert(Lists.max(List(3, 7, 2)) === 7)
  }
  
  test("max of a five numbers") {
    assert(Lists.max(List(3, 7, 2, 8, 9)) === 9)
  }
   test("max of a five negative numbers") {
    assert(Lists.max(List(-3, -7, -2,-8, -9)) === -2)
  }
